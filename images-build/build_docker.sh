...
packaging_fateboard() {
    ...
    docker run --rm -u $(id -u):$(id -g) -v ${source_dir}/fateboard/resources-front-end:/data/projects/fate/fateboard/resources-front-end node:8 /bin/bash -c "cd /data/projects/fate/fateboard/resources-front-end && npm install && npm run build"
